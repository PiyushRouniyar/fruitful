...
const manualInput = document.getElementById('manual-food-input');
const manualSearchBtn = document.getElementById('search-manual-btn');
...
function setupEventListeners() {
    ...
    manualSearchBtn.onclick = searchManualFood;
    manualInput.onkeypress = (e) => {
        if (e.key === 'Enter') searchManualFood();
    };
